...
#### sklearn
- there are a few `sklearn` models designed for text -- all use the familiar `sklearn` API
- a good starting point, and excellent for preprocessing
...
- excellent for learning, esp. when used with `dplyr::` and [Robinson & Silge (2016)](https://www.tidytextmining.com/)
